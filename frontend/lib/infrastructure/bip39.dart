...
class Bip39Mnemonic {
  static const List<String> _wordList = [
    ...
    "alert", "alien", "all", "alley", "allow", "almost", "alone", "along", "alpha", "already",
    ...
    "avoid", "awake", "award", "aware", "away", "awesome", "awful", "awkward", "axis", "baby",
    ...
    "cat", "catalog", "catch", "category", "cattle", "caught", "cause", "caution", "cave", "cavity",
    ...
    "colony", "color", "column", "combine", "come", "comfort", "comic", "common", "company", "comply",
    "concede", "concept", "concern", "concert", "conduct", "conduit", "congenial", "congress", "connect", "consider"
  ];

  static String generate() {
    final rand = Random.secure();
    final words = List<String>.generate(24, (_) {
      final index = rand.nextInt(_wordList.length);
